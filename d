...
wget http://xhome.tech/autoscript/Debian9/vnstat_php_frontend-1.5.1.tar.gz
...
wget http://xhome.tech/autoscript/Debian9/badvpn-1.999.127.tar.bz2
...
echo "========================================"  | tee -a log-install.txt
cat /dev/null > ~/.bash_history && history -cP
